...
s,n=re.subn(r'function computerPredictX\(\)\{.*?\}function computerControl\(\)\{.*?\}\}function loop\(\)\{',new+'function loop(){',s,count=1,flags=re.S)
if n!=1: raise SystemExit('computer control regex target not found')
