...
# Level transition and victory styling.
...
# Update level/box labels and start instructions.
...
# Add full-screen level and victory overlays before the main script.
...
# Replace old 50k flap progression with five 12M levels.
...
# New game resets the level system and victory overlays.
...
# Reset message includes the level.
...
# Make the existing artwork the actual board background.
...
# Physics runs in substeps so higher levels are faster without tunneling through paddles/walls.
...
# Facebook share: score + level + public game URL in Facebook's share composer.
